# SVM with linear kernel, trained using IU dataset and tested using external validation set.
...
save(resMetrics, youden, model, file = paste0('res_m2_svm_linear_test.RData'))
