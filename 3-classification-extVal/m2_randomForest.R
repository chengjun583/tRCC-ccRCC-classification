# Random forest, trained using IU dataset and tested using external validation set.
...
save(resMetrics, youden, rfModel, file = paste0('res_m2_randomForest_test.RData'))
